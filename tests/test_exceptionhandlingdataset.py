...
from edzipdataset import ExceptionHandlingMapDataset, TransformedMapDataset
import pickle
...
class TestExceptionHandlingMapDataset(unittest.TestCase):
    def setUp(self):
        self.dataset = TransformedMapDataset(TensorDataset(torch.arange(3)), _except_on_two)
